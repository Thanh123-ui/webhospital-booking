...
const mockDoctors = [
  ...
  { id: 11, deptId: 5, name: 'BS. Lê Văn Cấp',     title: 'BS Cấp cứu - Hồi sức',      avatar: '🧑‍⚕️', exp: '12 năm', username: 'bscap',    password: 'bscap@2024'    },
...
const initialPatients = [
  {
    ...
    password: 'pass@2024', gender: 'Nam', dob: '1980-05-12', address: 'Quận 1, TP.HCM',
    medicalHistory: [
  ...
  },
  {
    ...
    password: 'pass@2025', gender: 'Nữ', dob: '1995-08-20', address: 'Quận 3, TP.HCM',
    medicalHistory: [
